...
public class FirstController {
    ...
    public String printInfo() {
        return """
                ...
                Описание проекта: Простое и удобное веб-приложение, с помощью которого можно учитывать и автоматизировать учет товаров на складе интернет-магазина носков.\s
